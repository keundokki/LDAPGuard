...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('role', sa.Enum('admin', 'backup_admin', 'security_admin', 'operator', 'viewer', name='userrole'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('category', sa.Enum('directory', 'schema', 'config', 'acl', 'certificates', 'full_server', name='backupcategory'), nullable=False, server_default='directory'),
