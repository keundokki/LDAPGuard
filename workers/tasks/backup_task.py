...
from api.models.models import Backup, LDAPServer, BackupStatus, BackupType
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            MetricsService.record_backup_completed(
                backup.backup_type.value, duration,
                ldap_server.name, file_size, entry_count
            )
            ...
            # Send webhook notification
            await webhook_service.send_backup_failed(backup_id, ldap_server.name, str(e))
